...
models = ["SegRNN", "STGCN", "CNN-LSTM", "DCRNN-dist", "TSD",
          "LTransformer", "CrossFormer", "SageFormer", "DeepSOZ", "DSN"]
online = ["SegRNN", "CNN-LSTM", "DCRNN-dist", "LTransformer", "DSN"]
...
detection_time = {"SegRNN": [2.20, 4.11, 5.80, 6.79, 10.28, 12.73],
                  ...
                  "DeepSOZ": [3.21, 5.32, 6.44, 8.58, 12.44, 15.89],
...
memory = {"SegRNN": [857, 917, 957, 999, 1083, 1169],
          ...
          "DeepSOZ": [804, 1066, 1328, 1590, 2116, 2652],
...
if __name__ == '__main__':
    ...
    for m in models:
        if m in online:
            tp = a / np.array([detection_time[m][5]] * 6) * 120
        else:
    ...
    fig.legend(loc="upper center", fontsize=16, ncols=5, columnspacing=0.6)
    fig.tight_layout()
